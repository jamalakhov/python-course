...
current_wagon_number = int(input('Введите номер вагона от головы состава: '))
wagon_number = int(input('Введите порядковый номер вагона: '))

if current_wagon_number == wagon_number:
    print('Недостаточно информации для вычисления')
else:
    result = int(current_wagon_number + wagon_number - 1)
    print(result)